### Mục tiêu: Sử dụng AI để phát hiện những yêu cầu chưa đầy đủ hoặc chưa rõ trong BRD/SRS, từ đó hỗ trợ QA chuẩn bị bộ câu hỏi trao đổi với BA/PO trước khi bắt đầu thiết kế Test Case. Mục tiêu bao gồm:
...
- Không tự tạo Requirement mới.
- Đánh dấu mức độ ưu tiên High, Medium, Low.
Output: Trình bày dưới dạng file .md rõ ràng.
